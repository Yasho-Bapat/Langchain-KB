...
class Logger:
    ...
    def __init__(self):
        self.columns = [
            ...
            'tokens_used_for_analysis', 'cost_analysis', 'total_cost'
        ]
    ...
    def log(self, info):
        ...
        data = [time, user_id, material_name, tokens_used_for_chemical_composition, cost_chemical_composition, tokens_used_for_analysis, cost_analysis, total_cost]
